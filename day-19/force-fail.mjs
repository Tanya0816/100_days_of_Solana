...
//load the funded devnet wallet(the fee payer)
...
//Build a transfer of some SOL - far more than the funded wallet has
...
//skipPreflight bypasses local simulation ,so the trnasaction lands on-chain and fails there
await rpc
