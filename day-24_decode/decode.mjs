...
// `data` arrives as a [base64String, "base64"] tuplr. Convert the string back into the raw 82 bytes
...
// mint decoder knows exactly how the Token Program structures mint accounts.
...
console.log("Human-readable supply:", Number(supply) / Math.pow(10, decimals));

const isInitailized = view.getUint8(45) === 1;
console.log("Is Initailzed:", isInitailized);
