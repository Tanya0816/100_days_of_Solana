...
async function loadOrCreateWallet() {
    try {
        ...
        // No wallet filefound, create a new one
        ...
        //(Node.js doesnot support "raw" export for Ed25519 private keys)
...
if (balanceInSol === 0) {
    console.log(
        ` \nThis wallet has no SQL. Visit https://faucet.solana.com/ and airdrop some to:`
    );
